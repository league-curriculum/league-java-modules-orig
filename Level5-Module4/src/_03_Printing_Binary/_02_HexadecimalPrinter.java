...
public class _02_HexadecimalPrinter implements ActionListener {
    ...
    String binaryToHex(String binaryStr) {
        ...
        String hexStr = "";
        int decimalNum = binaryToInt(binaryStr);
        
        /*
         * This is adapted from _00_Binary_Conversion/_03_DecimalToBinary
         * so if the students understood that they should understand this
         */
        do {
            // 1. Logical right shift by 4
            int quotient = decimalNum >>> 4;
            
            char hexDigit = '\0';
            int remainder = decimalNum % 16;
            
            // 2. Check remainder and add '0' to 'F' as necessary
            switch(remainder) {
            case 10:
                hexDigit = 'A';
                break;
    ...
    String binaryToAscii(String binaryStr) {
        ...
        return "" + (char)binaryToInt(binaryStr);
    }
    
    /*
     * This is from _00_Binary_Conversion/_02_BinaryToDecimal
     */
    public int binaryToInt(String binaryStr) {
        ...
        for(int i = binaryStr.length() - 1; i >= 0; i--) {
            if( binaryStr.charAt(i) == '1' ) {
                ret += Math.pow(2, binaryStr.length() - 1 - i);
            }
        }
