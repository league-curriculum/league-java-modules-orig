...
public class TurfWar extends PApplet {
    ...
    class Player {
         ...
         * as parameters and initializes them in order.
         */
        int x;
        int y;
        int speed;
        ...
        Player(int x, int y, int speed, int playersize, int playerColor,
        ...
        /*
         * Note: These member variables do not need to be initialized in the
         * constructor.
         */
        ...
        void update() {
            /*
             * Note: This piece of codes makes the player move up without
    ...
    /*
     * 4. Create two variables of the Player class called player1 and player2.
    ...
    public void setup() {
        /*
         * Note: Do not change this code. It makes it so you can press the keys
         ...
         * or else they will be hidden behind the score board.
         * 
         ...
         */
        player1 = new Player(0,statsBoardLine, 2, 10, Color.BLUE.getRGB(), W,A,S,D);
        player2 = new Player(width - 10, height - 10, 2, 10, Color.RED.getRGB(), UP,LEFT,DOWN, RIGHT);
    ...
    public void keyPressed() {
        /*
         * 14. Call the enableMovement method for both players and pass keyCode
         * to the method.
         */
    ...
    public void keyReleased() {
        /*
         * 15. Call the disableMovement method for both players and pass keyCode
         * to the method.
         */
    ...
    /*
     * 16. Try to play a game of Turf War with someone nearby if possible. The
